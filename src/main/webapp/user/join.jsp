	...
	<div align="center">
		...
		<form action="joinForm.user" method="post">
			<table>
				<tr>
					<td>아이디</td>
					<td><input type="text" name="id" placeholder="4글자이상" required="required" pattern="[0-9A-Za-z]{4,}"></td>  <!-- pattern 뒤에는 js정규표현식(외우지는 말고 java랑 비슷하니 인터넷 서치해볼것) -->
				</tr>
				<tr>
					<td>비밀번호</td>
				...
				<tr>
					<td>남? 여?</td>
					<td>
						<input type="radio" name="gender" value="M" checked="checked">남자 <!-- checked="checked" 기본체크 -->
